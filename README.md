...
| [`ai-bubble-hedge`](packages/create-project/templates/ai-bubble-hedge) | Polymarket AI-downturn odds → JEV judgment → symbolic risk gates → approved paper put |
| [`cournot-competition`](packages/create-project/templates/cournot-competition) | Capacity-constrained Nash equilibrium → symbolic verification → Anthropic explanation |
